  ...
  <DeviceAppBarPage :title="pageTitle">
    ...
    <KPageContainer class="device-container">
      ...
      <div>
        ...
        <p v-if="!channelsAreCreated && !channelListLoading">
...
<script>
  ...
  import ChannelPanel from '../ManageContentPage/ChannelPanel/WithSizeAndOptions';
  import DeleteChannelModal from '../ManageContentPage/DeleteChannelModal';
  import TasksBar from '../ManageContentPage/TasksBar';

  export default {
    name: 'ManageLocalLibraryPage',
    metaInfo() {
      return {
    ...
    computed: {
      ...mapGetters('manageLocalLibrary', [
        'installedChannelsWithResources',
        'channelIsBeingDeleted',
        'managedTasks',
      ]),
      ...mapState('manageLocalLibrary', ['channelListLoading']),
      pageTitle() {
    ...
    methods: {
      ...mapActions('manageLocalLibrary', ['refreshChannelList', 'startImportWorkflow']),
      handleSelect({ value }) {
        const nextRoute = {
    ...
    $trs: {
      createNewChannel: {
        message: 'New Channel',
        context: 'Option to create a new custom channel for this device.',
      },
      documentTitle: {
      ...
      emptyChannelListMessage: {
        ...
        context: 'Will display if there are no local channels created in the Device > Local Library section.',
      },
    },
  };
